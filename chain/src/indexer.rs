use alto_types::{
    Activity, Block, CodingScheme, Finalized, Identity, Notarized, Scheme, Seed, Seedable,
};
use commonware_consensus::{
    marshal::coding::{self as marshal, types::DigestOrCommitment},
    Reporter, Viewable,
};
...
pub struct Pusher<E: Spawner + Metrics, I: Indexer> {
    context: E,
    indexer: I,
    marshal: marshal::Mailbox<Scheme, Block, CodingScheme>,
}
